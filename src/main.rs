...
use whyyoulying::{Alert, Config, DuplicateDetector, GhostDetector, Ingest, LaborDetector, RateEscalationDetector, SubcontractorDetector, TimeDetector};
...
fn run(cli: &Cli) -> Result<i32> {
    ...
    let rate_esc = RateEscalationDetector::f25(config.s68);
